...
import one from '../../images/avatar/1.jpg';
...
export default function Navsidebar() {
	...
	function demo1() {
		var element = document.getElementById("hmb_icon");
		if (element.classList == "fa fa-arrow-left") {
			element.classList.replace('fa-arrow-left', 'fa-arrow-right');
			var x = document.getElementById('div-slide');
			var y = document.getElementById("left-slide");
	...
	<!--**********************************
            Sidebar Fixed
        ***********************************--> */}
			<div class="fixed-content-box" id="div-slide">
				<div class="head-name">
					<div style={{ height: "auto", width: "auto", position: "fixed" }}>RC teambuilder</div>
				...
				<div class="fixed-content-body dz-scroll side-div" id="DZ_W_Fixed_Contant">
					<div class="tab-content" id="menu">
						...
						<div class="tab-pane fade" id="dashboard" role="tabpanel">
							<ul class="metismenu tab-nav-menu">
								<li style={{ color: "#22b1ed" }}>Recruit</li>
								<li>
					...
					<div class="tab-pane chart-sidebar fade show active" role="tabpanel">
						...
						<div class="card bg-info-light">
							...
							<div class="card-body">
								<p class="mb-2 d-flex"><img width="22" height="22" src={icon1}
								...
								<p class="mb-2 d-flex"><img width="22" height="22" src={icon2}
					...
					<nav class="navbar navbar-expand">
						<div class="collapse navbar-collapse justify-content-between">
							<div class="header-left">
								<span class="hamb d-md-none d-sm-none d-lg-block" onClick={demo1} >
									<i id="hmb_icon" class="fa fa-arrow-left"
										style={{ fontSize: "25px", fontWeight: " 500", color: "#22b1ed", marginRight: "20px" }} aria-hidden="true"></i>
								</span>


								{/* <i class="fa fa-arrow-right" aria-hidden="true"></i>  fa fa arrow right */}
							...
							<ul class="navbar-nav header-right">
												...
												<li>
													<div class="timeline-panel">
														<div class="media mr-2">
															<img alt="image" width="50" src={one} />
														</div>
								...
								<li class="nav-item dropdown header-profile">
									...
									<div class="dropdown-menu dropdown-menu-right">
										...
										<a href="" class="dropdown-item ai-icon" role="button"
			...
			<div class="deznav">
				<div class="deznav-scroll">
					<ul class="nav menu-tabs">
						<li class="nav-item" onClick={demo2}>
