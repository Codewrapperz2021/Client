    ...
    <div>
      ...
      <div class="deznav">
        <div class="deznav-scroll">
          ...
          <div class=" mt-4 mb-4">
            <CameraButton onClick={toggleCameraAudio} data-switch='video'>
              <div style={{ color: 'black', fontSize: '2%' }} class="sb-nav-link-icon">
                {userVideoAudio.video ? (
                  <FaIcon className='fas fa-video'></FaIcon>
                ) : (
                  <FaIcon className='fas fa-video-slash'></FaIcon>
              ...
              <p style={{ color: 'black', fontSize: '10px' }}>Camera</p>
            </CameraButton>
           </div>
            {showVideoDevices && (
              <SwitchList>
                ...
                <div style={{ color: 'black', fontSize: '10px' }}>Switch Camera</div>
              </SwitchList>
            )}
            <div class=" mb-4">
            <CameraButton onClick={toggleCameraAudio} data-switch='audio'>
             ...
             <p style={{ color: 'black', fontSize: '10px' }}>Audio</p>
            </CameraButton>
            </div>
            <div class=" mb-4">
            <ChatButton onClick={clickChat}>
              ...
              <p style={{ color: 'black', fontSize: '10px' }}>Chat</p>
            </ChatButton>
            </div>
            <div class=" mb-4">
            <ScreenButton onClick={clickScreenSharing}>
              ...
              <p style={{ color: 'black', fontSize: '10px' }}>Share Screen</p>
            </ScreenButton>
            </div>
            <div class=" mb-4">
            <StopButton onClick={goToBack}>
              ...
              <p style={{ color: 'black', fontSize: '10px' }} >Leave</p>
            </StopButton>
            </div>
            </div>
          </div>
